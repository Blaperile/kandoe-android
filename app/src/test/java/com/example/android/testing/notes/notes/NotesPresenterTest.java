...
//        // Callback is captured and invoked with stubbed notes
          verify(mNotesRepository).getNotes(mLoadNotesCallbackCaptor.capture()); //we want to catch the parameter that is given to the call
...
//        // Then add note UI is shown
        verify(mNotesView).showAddNote(); //check if this method has been called on view
    }
